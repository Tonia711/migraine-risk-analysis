...
The code under `src/` and any included demo artifacts (e.g., `Data/sample/` and `outputs/`) are covered by the same MIT license.

Raw NHIS data is not included in this repository (`Data/raw/`).
